...
export interface IButtonThemeProps {
   ...
   *
   * It is generally recommended to keep this feature enabled since it makes the text and icon more legible,
   * but can be disabled by setting this value to `true`.
   */
