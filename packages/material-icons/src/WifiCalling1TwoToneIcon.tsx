  ...
  function WifiCalling1TwoToneIcon(props, ref) {
    return (
      <SVGIcon {...props} ref={ref}>
        ...
        <path
          fillOpacity=".3"
          d="M16.49 6c-1.38 0-2.63.56-3.54 1.46l1.06 1.06c.63-.63 1.51-1.03 2.47-1.03s1.84.39 2.47 1.03l1.06-1.06A4.94 4.94 0 0 0 16.49 6z"
        />
        <path d="M16.49 9c-.55 0-1.05.22-1.41.59L16.49 11l1.41-1.41c-.36-.37-.86-.59-1.41-.59z" />
        <path
