...
export default function AddHomeWorkTwoToneIcon(
  props: SVGIconProps
): ReactElement {
  ...
  return (
    <SVGIcon {...remaining} ref={ref}>
      <path
        ...
        opacity=".3"
      />
      <path d="M12 5h9v6.68c.75.36 1.43.84 2 1.42V3H10v1.97l2 1.43z" />
      <path d="M17 7h2v2h-2zM8 6l-7 5v10h6v-5h2v5h2.68c-.43-.91-.68-1.92-.68-3v-4H5v5H3v-6.97l5-3.57 5 3.57v1.08c.57-.59 1.25-1.07 2-1.42V11z" />
      <path
