  ...
  function MacroOffTwoToneIcon(props, ref) {
    return (
      <SVGIcon {...props} ref={ref}>
        ...
        <path d="M2.81 2.81 1.39 4.22l4.42 4.42c-.19.4-.3.84-.3 1.29a3.147 3.147 0 0 0 3.58 3.11A3.15 3.15 0 0 0 12 15c.05 0 .11-.01.16-.01l1.64 1.64A8.853 8.853 0 0 0 12 22c2.02 0 3.88-.67 5.38-1.8l2.4 2.4 1.41-1.41L2.81 2.81zm11.63 16.75c.2-.54.47-1.04.79-1.5l.71.71c-.46.32-.96.59-1.5.79z" />
      </SVGIcon>
    );
  }
);
