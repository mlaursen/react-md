...
export default function Groups3TwoToneIcon(props: SVGIconProps): ReactElement {
  const { ref, ...remaining } = props;

  return (
    <SVGIcon {...remaining} ref={ref}>
      <path
        d="M15.43 15.48c-1.1-.49-2.26-.73-3.43-.73-1.18 0-2.33.25-3.43.73-.23.1-.4.29-.49.52h7.85a.98.98 0 0 0-.5-.52"
        opacity=".3"
      />
      <circle cx="12" cy="9" r="1" opacity=".3" />
