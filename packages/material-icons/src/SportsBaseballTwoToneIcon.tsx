...
export default function SportsBaseballTwoToneIcon(
  props: SVGIconProps
): ReactElement {
  ...
  return (
    <SVGIcon {...remaining} ref={ref}>
      <path
        d="M5.61 7.22C4.6 8.55 4 10.2 4 12s.6 3.45 1.61 4.78a5.975 5.975 0 0 0 0-9.56"
        opacity=".3"
      />
      <path
      ...
      />
      <path
        d="M18.39 7.22a5.975 5.975 0 0 0 0 9.56C19.4 15.45 20 13.8 20 12s-.6-3.45-1.61-4.78"
        opacity=".3"
      />
