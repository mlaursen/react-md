...
const FileUploadSVGIcon: React.SFC<ISVGIconProps> = props => <SVGIcon {...props}><path d="M9 16h6v-6h4l-7-7-7 7h4zm-4 2h14v2H5z"/></SVGIcon>;

export default FileUploadSVGIcon;
