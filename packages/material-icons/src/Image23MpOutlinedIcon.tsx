...
export default function Image23MpOutlinedIcon(
  props: SVGIconProps
): ReactElement {
  ...
  return (
    <SVGIcon {...remaining} ref={ref}>
      ...
      <path d="M11 10H8V9h2c.55 0 1-.45 1-1V6.5c0-.55-.45-1-1-1H6.5V7h3v1h-2c-.55 0-1 .45-1 1v2.5H11zm6.5.5v-4c0-.55-.45-1-1-1H13V7h3v1h-2v1h2v1h-3v1.5h3.5c.55 0 1-.45 1-1" />
    </SVGIcon>
  );
}
