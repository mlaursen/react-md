...
const TwitterIcon: React.SFC<{ className?: string }> = ({ className }) => (
  <SVGIcon style={{ fill: "#1DA1F2" }} viewBox="0 0 400 400" className={className} role="presentation">
...
const SimpleLinks: React.SFC<{}> = () => (
  <React.Fragment>
    ...
    <Link className="example-group__example" href="https://github.com" flexCentered={true}>
      <TextIconSpacing icon={<FontIcon iconClassName="fa fa-github" role="presentation" />}>GitHub</TextIconSpacing>
    </Link>
    ...
    <Text type="body-2">
      This example shows how you can create a link within any text. The <code>Text</code> component is not required, but
      it helps add default typography styles when needed. You can read more about typography from the material design
      website's{" "}
      <Link href="https://material.io/design/typography/understanding-typography.html">understanding typography</Link>{" "}
      page.
    </Text>
  </React.Fragment>
);
