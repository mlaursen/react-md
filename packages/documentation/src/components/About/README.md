...
The gzipped UMD bundle sizes are:
 - dist/umd/react-md.production.min.js 87.44 kB
 - dist/umd/react-md-with-font-icons.production.min.js 112.76 kB
 - dist/umd/react-md-with-svg-icons.production.min.js 180.14 kB
