...
The gizipped UMD bundle sizes are:
 - dist/umd/react-md.production.min.js 86.39 KB
 - dist/umd/react-md-with-font-icons.production.min.js 110.67 KB
 - dist/umd/react-md-with-svg-icons.production.min.js 176.48 KB
