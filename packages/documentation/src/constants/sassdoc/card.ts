...
const sassdoc: PackageSassDoc = {
  functions: {
    ...
    "rmd-card-theme-var": {
      ...
      source: "packages/card/src/_functions.scss#L31-L38",
  ...
  mixins: {
    "rmd-card-theme": {
      ...
      source: "packages/card/src/_mixins.scss#L27-L34",
      requires: [
        {
    ...
    "rmd-card-theme-update-var": {
      ...
      source: "packages/card/src/_mixins.scss#L42-L49",
      usedBy: [
    ...
    "rmd-card": {
      ...
      source: "packages/card/src/_mixins.scss#L53-L99",
      ...
      requires: [
        ...
        { name: "rmd-card-elevation", type: "variable", packageName: "card" },
        {
    ...
    "rmd-card-header": {
      ...
      source: "packages/card/src/_mixins.scss#L103-L121",
      usedBy: [{ name: "react-md-card", type: "mixin", packageName: "card" }],
      requires: [
        {
    ...
    "rmd-card-title": {
      ...
      source: "packages/card/src/_mixins.scss#L125-L139",
      usedBy: [{ name: "react-md-card", type: "mixin", packageName: "card" }],
      requires: [
    ...
    "rmd-card-subtitle": {
      ...
      source: "packages/card/src/_mixins.scss#L143-L152",
      usedBy: [{ name: "react-md-card", type: "mixin", packageName: "card" }],
      requires: [
        { name: "rmd-typography", type: "mixin", packageName: "typography" },
        { name: "rmd-theme", type: "mixin", packageName: "theme" },
    ...
    "rmd-card-content": {
      ...
      source: "packages/card/src/_mixins.scss#L156-L176",
      usedBy: [{ name: "react-md-card", type: "mixin", packageName: "card" }],
      requires: [
        { name: "rmd-theme", type: "mixin", packageName: "theme" },
        {
    ...
    "rmd-card-actions": {
      ...
      source: "packages/card/src/_mixins.scss#L180-L193",
      usedBy: [{ name: "react-md-card", type: "mixin", packageName: "card" }],
      requires: [
        {
    ...
    "react-md-card": {
      ...
      source: "packages/card/src/_mixins.scss#L196-L231",
  ...
  variables: {
    ...
    "rmd-card-color": {
      ...
      source: "packages/card/src/_variables.scss#L19",
      requires: [
        { name: "rmd-theme-var", type: "function", packageName: "theme" },
      ],
      packageName: "card",
    ...
    "rmd-card-secondary-color": {
      ...
      source: "packages/card/src/_variables.scss#L29-L33",
      requires: [
        { name: "rmd-theme-var", type: "function", packageName: "theme" },
        { name: "rmd-theme-tone", type: "function", packageName: "theme" },
        { name: "rmd-theme-surface", type: "variable", packageName: "theme" },
      ],
      packageName: "card",
      type: "Color",
      value:
    ...
    "rmd-card-border-radius": {
      ...
      source: "packages/card/src/_variables.scss#L49",
      usedBy: [{ name: "rmd-card", type: "mixin", packageName: "card" }],
      packageName: "card",
      type: "Number",
      value: "0.25rem",
    ...
    "rmd-card-header-padding": {
      ...
      source: "packages/card/src/_variables.scss#L53",
    ...
    "rmd-card-header-spacing": {
      ...
      source: "packages/card/src/_variables.scss#L65",
      usedBy: [{ name: "rmd-card-header", type: "mixin", packageName: "card" }],
      packageName: "card",
      type: "Number",
      value: "1rem",
    ...
    "rmd-card-content-padding": {
      ...
      source: "packages/card/src/_variables.scss#L69",
      usedBy: [
        { name: "rmd-card-content", type: "mixin", packageName: "card" },
      ],
      packageName: "card",
    ...
    "rmd-card-border-color": {
      ...
      source: "packages/card/src/_variables.scss#L85",
      usedBy: [{ name: "rmd-card", type: "mixin", packageName: "card" }],
      requires: [
        {
    ...
    "rmd-card-border-width": {
      ...
      source: "packages/card/src/_variables.scss#L91",
      usedBy: [{ name: "rmd-card", type: "mixin", packageName: "card" }],
      requires: [
        { name: "rmd-divider-size", type: "variable", packageName: "divider" },
      ],
      packageName: "card",
      type: "Number",
    ...
    "rmd-card-theme-values": {
      ...
      source: "packages/card/src/_variables.scss#L97-L101",
      usedBy: [
