...
const sassdoc: PackageSassDoc = {
  ...
  mixins: {
    "rmd-menu-theme": {
      ...
      source: "packages/menu/src/_mixins.scss#L22-L24",
      packageName: "menu",
      code:
    ...
    "rmd-menu-theme-update-var": {
      ...
      source: "packages/menu/src/_mixins.scss#L32-L34",
      packageName: "menu",
      ...
      parameters: [
        {
          ...
          name: "theme-style",
          description:
            "The menu theme style type to update. This should be one\n  of the `$rmd-menu-theme-values` keys.",
        },
        {
          type: "Color|String|Number",
          name: "value",
    ...
    "react-md-menu": {
      ...
      source: "packages/menu/src/_mixins.scss#L53-L63",
