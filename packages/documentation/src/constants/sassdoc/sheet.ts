...
const sassdoc: PackageSassDoc = {
  ...
  mixins: {
    ...
    "react-md-sheet": {
      ...
      source: "packages/sheet/src/_mixins.scss#L71-L156",
  ...
  variables: {
    "rmd-sheet-z-index": {
      ...
      source: "packages/sheet/src/_variables.scss#L13",
    ...
    "rmd-sheet-raised-z-index": {
      ...
      source: "packages/sheet/src/_variables.scss#L18",
      usedBy: [{ name: "react-md-sheet", type: "mixin", packageName: "sheet" }],
      packageName: "sheet",
      type: "Number",
    ...
    "rmd-sheet-overlay-z-index": {
      ...
      source: "packages/sheet/src/_variables.scss#L24",
      usedBy: [{ name: "react-md-sheet", type: "mixin", packageName: "sheet" }],
      packageName: "sheet",
      type: "Number",
    ...
    "rmd-sheet-elevation": {
      ...
      source: "packages/sheet/src/_variables.scss#L29",
      usedBy: [{ name: "react-md-sheet", type: "mixin", packageName: "sheet" }],
      packageName: "sheet",
      type: "Number",
      value: "2",
    ...
    "rmd-sheet-leave-duration": {
      ...
      source: "packages/sheet/src/_variables.scss#L42",
      packageName: "sheet",
      type: "Number",
      value: "0.15s",
      overridable: true,
    ...
    "rmd-sheet-touch-margin": {
      ...
      source: "packages/sheet/src/_variables.scss#L49",
      packageName: "sheet",
      type: "Number",
      value: "3.5rem",
      overridable: true,
    ...
    "rmd-sheet-static-width": {
      ...
      source: "packages/sheet/src/_variables.scss#L58",
      packageName: "sheet",
      type: "Number",
      value: "16rem",
      overridable: true,
    ...
    "rmd-sheet-touchable-max-height": {
      ...
      source: "packages/sheet/src/_variables.scss#L70",
      packageName: "sheet",
      type: "Number",
    ...
    "rmd-sheet-recommended-max-height": {
      ...
      source: "packages/sheet/src/_variables.scss#L81",
      usedBy: [{ name: "react-md-sheet", type: "mixin", packageName: "sheet" }],
      packageName: "sheet",
      type: "Number",
      value: "50%",
    ...
    "rmd-sheet-positions": {
      ...
      source: "packages/sheet/src/_variables.scss#L85",
      packageName: "sheet",
      type: "List",
    ...
    "rmd-sheet-enabled-positions": {
      ...
      source: "packages/sheet/src/_variables.scss#L91",
      packageName: "sheet",
      type: "List",
    ...
    "rmd-sheet-theme-values": {
      ...
      source: "packages/sheet/src/_variables.scss#L97-L105",
      usedBy: [
