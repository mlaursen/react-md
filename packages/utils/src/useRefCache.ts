 ...
 * and puts it into a ref that'll be updated each render. This is
 * pretty overkill for most places, but it's really nice when you
 * want to create event handlers that shouldn't update if the developer
 * used arrow functions to define callbacks. (A great example is for ref
