...
/**
 * This will return the scrollbar width for a specific OS by creating a
 * temporary element to compare the width between it's inner element and it's
 * own width when scrollbars are enabled. This is useful when your width
 * calculations need to exclude scrollbars since they are included by default
 * but content can't be shown underneath them for for static elements.
 *
 ...
 * and actually don't take up width real estate.
 *
 * @see https://stackoverflow.com/a/13382873
 * @param forced Boolean if the scrollbar width should be force updated. When
