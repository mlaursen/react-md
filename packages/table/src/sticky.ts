...
/**
 * A quick way to conditionally inherit the sticky context within a table.
 * If the sticky prop was defined and a boolean, it will be used. Otherwise
 * the inherited context value will be used.
 * @private
 */
