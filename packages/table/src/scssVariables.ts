...
export default {
  ...
  "rmd-table-row-selected-color": "var(--rmd-theme-primary, #9c27b0)",
  "rmd-table-row-selected-hover-color": "",
  ...
  "rmd-table-theme-values": {
    ...
    "selected-color": "var(--rmd-theme-primary, #9c27b0)",
    "selected-hover-color": null,
    "sticky-header": 0,
    "sticky-cell": 0,
    "sticky-footer": 0,
  },
