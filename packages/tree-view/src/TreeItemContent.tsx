...
export interface ITreeItemContentBaseProps extends IListItemBaseProps {
  ...
  /**
   * The component to use that renders a `Link` component. This should normally be something
   * like the `Link` from `react-router` or `reach-router`, but can also just be the `Link`
   * from `@react-md/link` if you are not creating a SPA.
   */
