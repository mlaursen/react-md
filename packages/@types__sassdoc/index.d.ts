...
declare module "sassdoc" {
  ...
  export interface ItemRequire {
     ...
     *
     * This will be `undefined` if the item is required by a function or mixin
     * without the `@require` annotation.
     */
    description?: string;
  ...
  export interface SassFile {
     ...
     * styles
     * ΓööΓöÇΓöÇ src
     * Γö£ΓöÇΓöÇ _functions.scss
     * Γö£ΓöÇΓöÇ _mixins.scss
     * ΓööΓöÇΓöÇ _variables.scss
     * ```
     *
     * ```ts
     * parse("styles");
  ...
  export type Item<
    ...
    DT extends string = DataType,
  > = PlaceholderItem | VariableItem<DT, T> | MixinItem<T> | FunctionItem<T>;
