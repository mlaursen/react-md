...
export class MagicTooltipConsumer extends React.Component<IMagicTooltipConsumerProps, IMagicTooltipConsumerState> {
...
const MagicTooltip: React.SFC<ITooltipProps> = ({ id, ...props }) => (
  <Consumer>
    {({ visibleId, init, deinit, dense, spacing, denseSpacing }) => (
