    ...
    <div className="poll">
      <Card sx={{ maxWidth: 345 }} key="poll-card">
        <CardMedia
          component="img"
          height="140"
          image="https://firebasestorage.googleapis.com/v0/b/showintel-8dcf8.appspot.com/o/vote.jpg?alt=media&token=dff93452-c778-4e26-90d2-456dda7bf415"
          alt="Create a Poll"
        />
        <CardContent>
          ...
          {!showPollWidget
            ? [
                <Typography
                  ...
                  key="poll-card"
                >
                  Poll your audience in real-time and gather valuable insights
                  directly from your community to inform your next action.
                </Typography>,
              ]
            : [
                <div>
