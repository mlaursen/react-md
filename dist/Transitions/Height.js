    ...
    _this.init = function (done) {
      ...
      if (isEnter) {
        ...
        _this.animatePadding(el, 0, _this.linearIncrement(paddingTop, ptTime / increment), 'paddingTop', 0, ptTime, increment, function () {
          (0, _PropUtils.animate)(el, increment, ptTime, hTime, 'height', 0, paddingTop, fullHeight, done);
        });
      } else {
        el.style.paddingTop = paddingTop + 'px';
        el.style.height = fullHeight + 'px';
        (0, _PropUtils.animate)(el, increment, 0, hTime, 'height', fullHeight - paddingTop, fullHeight, -fullHeight, function () {
