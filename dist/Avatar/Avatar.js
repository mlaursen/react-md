...
var Avatar = (function (_Component) {
  ...
  function Avatar(props) {
    ...
    _this.getColor = function () {
      ...
      var maxColor = _this$props.maxColor;

      if (!(0, _PropUtils.isPropEnabled)(_this.props, 'random') && !color) {
        return null;
      }

      var i = color || Math.floor(Math.random() * maxColor) + 1;
  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)('md-avatar', className, this.getColor()) },
