...
export const SCSS_MODULES: Record<string, FakeScssModule> = {
  ...
  "src/app/components/tree/CustomTreeItemRendererExample.module.scss": {
    css: ".CustomTreeItemRendererExample_selected__Q3Vzd {\n  --rmd-icon-color: currentcolor;\n}",
    scss: '@use "everything";\n\n.selected {\n  @include everything.icon-set-var(color, currentcolor);\n}\n',
    baseName: "CustomTreeItemRendererExample",
    fileName: "CustomTreeItemRendererExample.module.scss",
  },
  "src/app/components/tree/DecreasingSpacingExample.module.scss": {
    css: ".DecreasingSpacingExample_tree__RGVjc {\n  --rmd-tree-item-padding-incrementor: 1rem;\n}",
