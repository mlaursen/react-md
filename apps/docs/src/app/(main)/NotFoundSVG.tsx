    ...
    >
      <defs>
        ...
        <linearGradient id="b" x1="82.093%" x2="51.806%" y1="75.079%" y2="100%">
          <stop
            offset="0%"
            stopColor="var(--rmd-text-primary-color)"
            stopOpacity="0"
          />
          <stop offset="48.245%" stopColor="var(--rmd-text-primary-color)" />
          <stop offset="100%" stopColor="var(--rmd-text-primary-color)" />
        </linearGradient>
        <linearGradient id="g" x1="50%" x2="50%" y1="0%" y2="95.873%">
          <stop offset="0%" stopColor="var(--rmd-text-primary-color)" />
          <stop
            offset="100%"
            stopColor="var(--rmd-text-primary-color)"
            stopOpacity="0"
      ...
      <g fill="none" fillRule="evenodd">
        <g transform="translate(709 259)">
          <ellipse
            cx="251"
            cy="280.085"
            stroke="var(--rmd-text-primary-color)"
            strokeWidth="10"
            rx="251"
            ry="99.574"
          />
        ...
        <path fill="url(#l)" d="m1187.453 306.92-70.093 159.883-9.582-2.979z" />
        <text
