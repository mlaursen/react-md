---
title: Collapse
description: The collapse transition can be used to animate an element in and out of view vertically by collapsing the content like an accordion.
docType: Demo
docGroup: Components
group: Transition
...
vertically line an accordion by using the `Collapse` component or
