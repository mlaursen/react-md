...
- `"small"` - uses `var(--rmd-dialog-small-width)` and configured by `core.$dialog-small-width`
- `"medium"` - uses `var(--rmd-dialog-medium-width)` and configured by `core.$dialog-medium-width`
- `"large"` - uses `var(--rmd-dialog-large-width)` and configured by `core.$dialog-large-width`
- `"extra-large"` - uses `var(--rmd-dialog-extra-large-width)` and configured by `core.$dialog-extra-large-width`
