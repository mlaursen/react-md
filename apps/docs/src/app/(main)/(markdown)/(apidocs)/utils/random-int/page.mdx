---
title: randomInt
description: The randomInt function can be used to generate a random integer between a min and max value.
docType: API Docs
docGroup: Numbers
group: Utils
---
...
The `randomInt` function can be used to generate a random
