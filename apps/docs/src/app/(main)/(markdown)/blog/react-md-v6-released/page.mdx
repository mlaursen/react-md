...
import interactionAfter from "./normal-hover-focus-after.png";
import interactionBefore from "./normal-hover-focus-before.png";
...
<Image src={interactionBefore} alt="Interaction states before v6" />

After

<Image src={interactionAfter} alt="Interaction states with v6" />
