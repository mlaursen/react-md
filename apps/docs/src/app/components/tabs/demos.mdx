...
{{ "component": "./WithIconsExample.tsx" }}
...
{{ "component": "./ControllingTheActiveTabExample.tsx" }}
...
{{ "component": "./CustomActiveTabIndexExample.tsx" }}
...
{{ "component": "./CustomActiveTabExample.tsx" }}
...
{{ "component": "./ScrollableTabsExample.tsx" }}
...
{{ "component": "./ScrollableTabsWithScrollbarExample.tsx" }}
...
{{ "component": "./CustomScrollBehaviorExample.tsx" }}
...
{{ "component": "./VerticalTabsExample.tsx" }}
...
{{ "component": "./DisableActiveTabTransitionExample.tsx" }}
...
{{ "component": "./DisableVerticalActiveTabTransitionExample.tsx" }}
...
{{ "component": "./CustomTabPanelsExample.tsx" }}
...
{{ "component": "./ActivationModeExample.tsx" }}
