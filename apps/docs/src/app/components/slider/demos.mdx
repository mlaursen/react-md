...
{{ "component": "./HorizontalSlider.tsx" }}
...
{{ "component": "./VerticalRangeSlider.tsx" }}
...
{{ "component": "./CustomizingDiscreteSliderTooltip.tsx" }}
...
{{ "component": "./CustomizingSliderMarks.tsx" }}
...
{{ "component": "./LinkedWithATextField.tsx" }}
