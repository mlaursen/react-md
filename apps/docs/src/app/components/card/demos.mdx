...
{{ "component": "./FullWidthCardExample.tsx" }}
...
{{ "component": "./CardWithMediaExample.tsx" }}
...
{{ "component": "./AdditionalCardComponentsExample.tsx" }}
...
{{ "component": "./CardHeaderAddonsExample.tsx" }}

# Card Grid

Multiple cards can be rendered in a grid using the `Box` component.

{{ "component": "./CardGridExample.tsx" }}
...
{{ "component": "./ExpandableCardExample.tsx" }}
...
{{ "component": "./ClickableCardExample.tsx" }}
