...
```tsx
// preview editable styles="src/app/components/table/StickyActiveStylesExample.module.scss"
import {
  Table,
  TableBody,
  TableCell,
...
```tsx
// preview editable styles="src/app/components/table/DisableStickyActiveStylesExample.module.scss"
import {
  Table,
  TableBody,
  TableCell,
