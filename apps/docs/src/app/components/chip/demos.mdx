...
{{ "component": "./SimpleChipExample.tsx" }}

## Chip Themes

The chip supports two themes: `"solid"` (default) and `"outline"`.

{{ "component": "./ChipThemeExample.tsx" }}
...
{{ "component": "./DisabledChipExample.tsx" }}
...
{{ "component": "./ChipWithAddonsExample.tsx" }}
...
{{ "component": "./ChipWithCircularProgressExample.tsx" }}
...
{{ "component": "./SelectableChipExample.tsx" }}
...
{{ "component": "./CustomSelectedIconExample.tsx" }}
...
{{ "component": "./ThemedSelectedStateExample.tsx" }}
...
{{ "component": "./PresentationalChipsExample.tsx" }}
