...
const fifteenThirtyTwo = new Date(Date.UTC(2016, 3, 2, 19, 32));

describe('stripTime', () => {
  it('removes all time from a date. Only keeps year, month, and date', () => {
    const expected = new Date(Date.UTC(2016, 2, 14, 4));
...
describe('getLastDate', () => {
  it('strips the time from the last day in the month', () => {
    const march31 = new Date(Date.UTC(2016, 2, 31, 4));
...
describe('getDayOfWeek', () => {
  it('gets a relative day of the week from any given date', () => {
    const monday2016April4 = new Date(Date.UTC(2016, 3, 5));
    const sunday2016April3 = new Date(Date.UTC(2016, 3, 4));
  ...
  it('can return a day of the week from the previous month', () => {
    const april1 = new Date(Date.UTC(2016, 3, 2));
    const march31 = new Date(Date.UTC(2016, 2, 32));
...
describe('addDate', () => {
  it('adds days to a date', () => {
    const march15 = new Date(Date.UTC(2016, 2, 15, 15, 22, 18, 450));
    const march22 = new Date(Date.UTC(2016, 2, 22, 15, 22, 18, 450));
  ...
  it('can add negative days to a date', () => {
    const march13 = new Date(Date.UTC(2016, 2, 13, 15, 22, 18, 450));
    const march1 = new Date(Date.UTC(2016, 2, 1, 16, 22, 18, 450));
...
describe('addHours', () => {
  it('adds hours to a date', () => {
    const fiveFiftyOne = new Date(Date.UTC(2016, 3, 2, 9, 51));
...
describe('subtractHours', () => {
  it('adds hours to a date', () => {
    const oneFiftyOne = new Date(Date.UTC(2016, 3, 2, 5, 51));
