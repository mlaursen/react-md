...
var IconButton = function (_Component) {
  ...
  _createClass(IconButton, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['iconClassName', 'children', 'className', 'href', 'type', 'tooltip', 'tooltipClassName', 'tooltipPosition']);

      var btnProps = _extends({}, props, {
        className: (0, _utils.mergeClassNames)(props, 'md-btn', 'md-icon-btn', className)
      });
      ...
      var disabled = (0, _utils.isPropEnabled)(props, 'disabled');
