...
var Menu = function (_Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props2, ['className', 'listClassName', 'listStyle', 'children', 'toggle', 'isOpen', 'position', 'close', 'autoclose', 'cascading', 'expanderIconChildren', 'expanderIconClassName']);

      var items = isOpen && _react2.default.Children.map(children, function (child, key) {
        if (!child) {
          return child;
        }
