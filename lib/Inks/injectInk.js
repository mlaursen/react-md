  ...
  return _temp = _class = function (_Component) {
    ...
    function Ink(props) {
      ...
      _this.handleMouseLeave = function (e) {
        ...
        _this.popInk();
        _this.setState({ skipMouseUp: true });
      };

      _this.handleMouseUp = function (e) {
        _this.props.onMouseUp && _this.props.onMouseUp(e);
        if (_this.invalidClickEvent(e) || _this.state.skipMouseUp) {
          return;
        }
        _this.popInk();
        _this.setState({ skipFocus: false });
      };
