...
var TimePicker = function (_Component) {
  ...
  _createClass(TimePicker, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['okLabel', 'okPrimary', 'onOkClick', 'cancelLabel', 'cancelPrimary', 'onCancelClick', 'DateTimeFormat', 'locales', 'className', 'setTimeMode', 'setTempTime', 'timeMode', 'tempTime', 'hours', 'minutes', 'timePeriod']);

      var hoursInt = parseInt(hours);
      var minutesInt = parseInt(minutes.replace(/[^0-9]/g, ''));
