...
var TimePickerContainer = function (_Component) {
  ...
  _createClass(TimePickerContainer, [{
    ...
    value: function render() {
      ...
      if (textFieldValue) {
        textFieldValue = (0, _dates.getTimeString)(props.DateTimeFormat, props.locales, textFieldValue);
      }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.closeOnOutside = function (e) {
    return (0, _utils.onOutsideClick)(e, _this2.refs.container, _this2.close);
  };
  ...
  this.getTimeParts = function (date) {
    ...
    return (0, _dates.extractTimeParts)(props.DateTimeFormat, props.locales, date);
  };
  ...
  this.handleOkClick = function (e) {
    ...
    if (onChange) {
      onChange(value, (0, _dates.getTimeString)(DateTimeFormat, locales, value), e);
    }
