...
var Card = function (_Component) {
  ...
  function Card(props) {
    ...
    _this.getChildContext = function () {
      ...
      var expanderTooltipLabel = _this$props.expanderTooltipLabel;
      var expanderTooltipPosition = _this$props.expanderTooltipPosition;

      return {
        onExpandClick: _this.handleExpandClick,
        isExpanded: typeof isExpanded !== 'undefined' ? isExpanded : _this.state.expanded,
    ...
    _this.handleExpandClick = function (e) {
      if (_this.props.onExpanderClick) {
        _this.props.onExpanderClick(e);
      }

      if (typeof _this.props.isExpanded === 'undefined') {
