...
var DialogContainer = function (_Component) {
  ...
  _createClass(DialogContainer, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['actions', 'isOpen', 'title', 'children', 'className', 'contentClassName', 'containerClassName', 'modal', 'close', 'actionLeft', 'actionRight', 'style', 'transitionName', 'transitionEnter', 'transitionEnterTimeout', 'transitionLeave', 'transitionLeaveTimeout']);
