...
var Tabs = function (_Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var remainingProps = _objectWithoutProperties(_props, ['className', 'children', 'style', 'fixedWidth', 'centered', 'primary']);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.calcTabMoveDistance = function (_ref) {
    ...
    maxWidth -= tabContainer.offsetWidth - parseInt(_this3.props.style.marginLeft || 0);
