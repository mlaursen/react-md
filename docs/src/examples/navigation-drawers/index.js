...
import NewNavigationDrawer from './NewNavigationDrawer';
import NewNavigationDrawerRaw from '!!raw!./NewNavigationDrawer';

export default [{
  code: NewNavigationDrawerRaw,
  children: <NewNavigationDrawer />,
}];
